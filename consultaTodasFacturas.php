...
error_reporting(0);
  ...
  $fecha = $_POST['fecha'];
  $query2="SELECT sum(total) as total2 from facturas";
    ...
    $tabla="";
    $query="SELECT *
     from facturas where fecha_factura like '$fecha%'";
    ...
    if(!empty($buscarAlumnos) AND mysqli_num_rows($buscarAlumnos)>0)
    {
        ...
        '
        <strong style="float: left; margin-left:0 %; font-size: 20px; margin-top: 70px; font-style: italic;"><label>Total facturas <input type="text" value='.formatMoney($result2['total2']).'></label><a href="exportExcelFacturasTodas" ><i class="fas fa-cloud-download-alt" style="font-size: 25px"></a></i></strong>
