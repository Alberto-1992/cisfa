       ...
       <div class="container" style="width: 750px; margin-top: 35px;">
        ...
        -->
            ...
            Subdirección de Recursos Materiales.</p></div>
                ...
                <form action="editarMedicamento" id="register-form" method="POST" autocomplete="off">
                ...
                <div class="form-body">
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                <div class="input-group-addon"><span class="glyphicon glyphicon-envelope"></span></div>
                                <input name="id_medicamento" type="hidden" class="form-control" value="<?php echo $row['id_medicamento']; ?>"
                                    required="required"
                                    onkeyup="mayus(this);">
                            </div>
                        </div>
                    <div class="form-group">
                        <strong>NÚMERO DE CONTRATO/PEDIDO</strong>
                            <div class="input-group">
                                <div class="input-group-addon"><span class="glyphicon glyphicon-envelope"></span></div>
                                <input name="numeroContrato" type="text" class="form-control" value="<?php echo $row['numeroContrato']; ?>"
                                    required="required"
                                    onkeyup="mayus(this);">
                            </div>
                        </div>
                       ...
                       <!-- <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input name="grupo" type="text" class="form-control" 
                                   value="<?php echo $row['GRUPO'];?>" onkeyup="mayus(this);">
                            </div>
                        </div>-->
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <div class="input-group-addon"><span class="glyphicon glyphicon-envelope"></span></div>
                                <input name="designacion" type="text" class="form-control" placeholder="DESIGNACION"
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <div class="input-group-addon"><span class="glyphicon glyphicon-envelope"></span></div>
                                <input name="financiamiento" type="text" class="form-control" 
                                     value="<?php echo $row['tipoAdjudicacion'];?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <div class="input-group-addon"><span class="glyphicon glyphicon-envelope"></span></div>
                                <textarea name="descripcion" rows="8" class="form-control" placeholder="DESCRIPCION"
                                    required="required" onkeyup="mayus(this);"><?php echo $row['DESCRIPCION'];?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input name="clave_cuadro_basico" type="text" class="form-control"
                                    placeholder="CLAVE DE CUADRO BASICO" required="required" onkeyup="mayus(this);" value="<?php echo $row['CLAVEDECUADROBASICO'];?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <strong>CUCOP</strong>
                            <div class="input-group">
                                <div class="input-group-addon"><span class="glyphicon glyphicon-envelope"></span></div>
                                <input name="cucop" type="text" class="form-control" placeholder="CUCOP"
                                    required="required" onkeyup="mayus(this);" value="<?php echo $row['CUCOP'];?>">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <div class="input-group-addon"><span class="glyphicon glyphicon-envelope"></span></div>
                                <input name="unidad_medida" type="text" class="form-control" placeholder="UNIDAD DE MEDIDA"
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input name="precio_unitario_sin_iva" type="number" class="form-control"
                                placeholder="PRECIO UNITARIO ADJUDICADO SIN I.V.A." required="required" id="txt_campo_1"
                                onchange="multiplicar(this.value);" value="<?php echo $row['PRECIOUNITARIO']; ?>" min="0.0" max="900000.00" step="0.01">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input name="hraei_minimo" type="text" class="form-control"
                                placeholder="HOSPITAL REGIONAL DE ALTA ESPECIALIDAD IXTAPALUCA(CONSUMO MÍNIMO)"
                                required="required" id="txt_campo_2" onchange="multiplicar(this.value);" value="<?php echo $row['MINIMOCONSUMO']; ?>">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <div class="input-group-addon"><span class="glyphicon glyphicon-lock"></span></div>
                            <input name="hraei_maximo" type="text" id="txt_campo_3"  onchange="multiplicar(this.value);" class="form-control"
                                placeholder="HOSPITAL REGIONAL DE ALTA ESPECIALIDAD IXTAPALUCA(CONSUMO MAXIMO)"
                                required="required" value="<?php echo $row['MAXIMOCONSUMO']; ?>">
                        </div>
                    </div>

                    <div class="form-group">
                        <strong>COSTO MINIMO</strong>
                        <div class="input-group">
                            <div class="input-group-addon"><span class="glyphicon glyphicon-lock"></span></div>
            ...
            <div class="form-footer">
                ...
                <input type="submit" class="btn btn-info" name="editarMedicamento" value="ACTUALIZAR">
                <a href="#" class="btn btn-danger" onclick="window.close();" >Finalizar </a>
