...
<?php
//require_once 'modals/buscarMedicamento.php';
require_once 'modals/contratos.php';
//require_once 'modals/medicamentoEnOrden.php';
//require_once 'modals/medicamentoConsolidado.php';
require_once 'modals/cargarContrato.php';
require_once 'modals/registrarProveedor.php';
//require_once 'modals/cargarFactura.php';
require_once 'modals/salidasCisfa.php';
//require_once 'modals/consultarFactura.php';
