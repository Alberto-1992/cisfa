...
<body>
  ...
  $sql_r = $conexion2->query("SELECT id_contrato, id_orden from numeroorden where claveUnicaContrato='$claveUnica3'");
  $rl = mysqli_fetch_assoc($sql_r);

  $id_unico = $rl['id_contrato'];
  $id_unico3 = $id_unico;
  $id_unico5 = base64_encode($id_unico);
  $id_orden = $rl['id_orden'];
  $id_orden2 = base64_encode($id_orden);
