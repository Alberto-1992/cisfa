...
<head>
   ...
   <link rel="stylesheet" href="https://cdn.linearicons.com/free/1.0.0/icon-font.min.css">
    ...
    <script src="scripts/consultaSuministrosFG.js"></script>
...
$('.nav-item dropdown').hover(function(){
    ...
    ?>
     <div class="box2">
        <div class="box1">
    <?php
       require'menuCisfa/menuSuministrosFG.php';
 ...
 <div class="box03"> 
  ...
  <input list="medicamentoEnOrden" class="form-control" id="medicamento_orden2" style="margin-left: 5px; margin-top: 45px; width: 450px; height: 40px;"  onchange="medicamento_enorden2();" placeholder="Clave, Nombre o CNIS del Medicamento">
           
        <datalist id="medicamentoEnOrden" >
            <?php
            require 'conexion.php';
            $sql_s = $conexion2->query("SELECT DISTINCT claveHraei, descripcionDelBien FROM ordensuministro where fechacontrato = '2023' and farmacia = 'gratuita'");
  ...
  <label class="lnr lnr-magnifier"  data-toggle="modal"
        ...
        <div id="tabla_resultado" class="table table-responsive table-striped table-darkgray table-hover" style="cursor: pointer; width: 99%; margin-left: 5px; margin-top: 0px; font-size: 12px;">
                <!-- AQUI SE DESPLEGARA NUESTRA TABLA DE CONSULTA -->
        </div>
        <div id="tabla_resultados" class="table table-responsive table-striped table-darkgray table-hover" style="cursor: pointer; width: 99%; margin-left: 5px; margin-top: 0px; font-size: 12px;">
                <!-- AQUI SE DESPLEGARA NUESTRA TABLA DE CONSULTA -->
        </div>
          
         <div id="tabla_resultado2" class="table table-responsive table-striped table-darkgray table-hover" style="cursor: pointer; width: 99%; margin-left: 5px; margin-top: 0px; font-size: 12px;"></div>
     </div>
</div>
