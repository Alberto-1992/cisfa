...
ordensuministro.importe, ordensuministro.claveUnicaOrden, ordensuministro.claveContrato, proveedores.numero_pedido, proveedores.suficiencia_presupuestaria, numeroorden.totalOrden, numeroorden.fechaRegistro from ordensuministro inner join proveedores on proveedores.id_proveedor =$var inner join numeroorden on claveUnicaContrato = '$num' and ordensuministro.claveUnicaOrden ='$num' and ordensuministro.claveContrato =$var";
...
$this->Cell(800, 1, '',0, 0, 'C', 'true');
      ...
      function Footer()
   {
    ...
    //$contenido = $row_n['totalOrden'];
//$contenido2 = "Bases de datos";
//$fechaActual = date('d-m-Y');
   ...
   // QRcode::png("Proveedor: ".$contenido."Nombre del curso: ".' '. $contenido2.''."Fecha: ".''.$fechaActual, "resultado.png", QR_ECLEVEL_L,5,2);
    ...
    $this->Image('imagenes/logopie2023.png' , 0 ,550, 840 , 40);
...
Encargado de los Asuntos Inherentes del Centro Integral de Servicios Farmacéuticos. '), 0);
    ...
    */
    ...
    $pdf->Ln(25);
    $pdf->Cell(300, -70, utf8_decode('Número de procedimiento: ').$row_s['suficiencia_presupuestaria'], 0);
    $pdf->Ln(-25);
    $pdf->MultiCell(300, 10, ('Domicilio de entrega: ').utf8_decode($domicilio), 0);
    $pdf->Ln(5);
    $pdf->MultiCell(300, 10, ('Fecha de entrega:').utf8_decode($fecha), 0);
    ...
    $pdf->tablewidths = array(84,70,83,60,300,40,40,70,60);
