...
<script>
    ...
    $(document).on("keyup", "#pzasEntrego", function() {
    ...
    $(document).on("keyup", "#fechaParcial", function() {
    ...
    $(document).on("click", "#monto2", function() {
    ...
    $(document).on("keyup", "#fechaParcial2", function() {
    ...
    $(document).on("click", "#monto3", function() {
    ...
    $(document).on("keyup", "#fechaParcial3", function() {
    ...
    $(document).on("click", "#monto4", function() {
    ...
    $(document).on("keyup", "#fechaParcial4", function() {
    ...
    $(document).on("click", "#monto5", function() {
    ...
    $(document).on("keyup", "#fechaParcial5", function() {
