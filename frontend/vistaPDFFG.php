...
<body>
    ...
    <header style="background-color: #1778A9">
        ...
        <label class="lnr lnr-menu" style="font-size: 23px; font-style: italic; float: left; margin-left: 18px; color: white;">Menu</label>
                 ...
                 <th>Fecha en que entrego todo el insumo</th>-->
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="verPDFFG?var=' . $var3 . '&valor2=' . $claveUnica . '" target="_blank"><i id="pdf" class="lnr lnr-file-empty"  style="width: 50px; height: 20px; font-size: 22px; text-align: center;"></a></i></td>
