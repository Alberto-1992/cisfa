...
<head>
    ...
    <script src="scripts/tablamedicamentobus.js"></script>
    ...
    <script src="scripts/medicamentosbus.js"></script>
...
<body>
    ...
    <div id="box1">
        <div class="imagenCisfa" style="margin-top: 25px; border-radius: 25px; height: 94px;"></div>

        <input list="consult_medica" class="form-control col-md-4" id="buscardor" type="text" onchange="btn_buscar_medicamento();" placeholder="Clave, Nombre o CNIS del Medicamento">

        <datalist id="consult_medica">
            <?php
            require 'conexion.php';
            $sql_s = $conexion2->query("SELECT DISTINCT DESCRIPCION, CLAVEHRAEI FROM listamedicamento where  fechaContrato = '2023' and farmacia = 'intrahospitalaria'");
        ...
        <input type="submit" data-toggle="modal" data-target="#myModal_cargamedicamento" class="btn btn-success" value="  +  Cargar Medicamento" id="boton">
