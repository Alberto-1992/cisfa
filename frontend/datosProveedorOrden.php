...
<div class=""><label class="dropdown-item"><input type="submit" data-toggle="modal"
                    data-target="#myModal_folio"
                    style="margin-left: 0px; background: none; color: blue; font-size: 14px; cursor: pointer;"
                value="Cargar N° de Folio"></div>
<!--               
<div class=""><label class="dropdown-item"><input type="submit" data-toggle="modal"
                    data-target="#myModal_folio"
                    style="margin-left: 0px; background: none; color: blue; font-size: 14px; cursor: pointer;"
                value="Cargar folio FONSABI"></div>
                ...
                <div class="form-group">
                        <strong>Ultimo numero de folio ocupado</strong>
                            <div class="input-group">
                                ...
                                <input name="numOrden" type="text" class="form-control"
                                    required="required"
                                    onkeyup="mayus(this);" value="<?php error_reporting(0); echo $res['claveUnicaContrato']; ?>" readonly="readonly">
                            </div>

                        </div>
                        
                    <!--<div class="form-group">
                        <strong>Ultimo numero de folio fonsabi ocupado</strong>
                            <div class="input-group">
                                <div class="input-group-addon"><span class="glyphicon glyphicon-envelope"></span></div>
                                <input name="numOrden" type="text" class="form-control"
                                    required="required"
                                    onkeyup="mayus(this);" value="<?php echo $resp['claveUnicaContrato']; ?>" readonly="readonly">
                            </div>
            ...
            <div class="form-group">
                        ...
                        <strong>SELECCIONA LA CLAVE INTRAHOSPITALARIA</strong>
                            <select class="form-control" id="mySelect" name="claveUnicaContrato" style="height: 35px;">
                                ...
                                $sql_s = $conexion2->query("SELECT * FROM numeroorden where estatus = 0 and id_contrato = $id_prov");
                    ...
                    <div class="form-group">
                        ...
                        <strong>SELECCIONA LA CLAVE FONSABI</strong>
                            <select class="form-control" id="mySelect2" name="claveUnicaContrato2" style="height: 35px;">
                                ...
                                $sql_s = $conexion2->query("SELECT * FROM numeroorden where claveUnicaContrato like '%$fonsabi%' and estatus = 0");
                                while ($row_s = mysqli_fetch_array($sql_s)) {
                                    $ID_usuario2 = base64_encode($row_s['claveUnicaContrato']);
                                    $nombre = $row_s['claveUnicaContrato'];
                                    ?>
                        ...
                        <strong>Contrato N°</strong>
                            <div class="input-group">
                                <div class="input-group-addon"><span class="glyphicon glyphicon-envelope"></span></div>
                                <input name="contrato" type="text" class="form-control"
                                    placeholder="OFICIO DE INFORME DE NOTIFICACIÓN" required="required"
                                    onkeyup="mayus(this);" value="<?php echo $contrato;?>" readonly="readonly">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <div class="input-group-addon"><span class="glyphicon glyphicon-envelope"></span></div>
                                <input name="oficio_informe" type="text" class="form-control"
                                    required="required"
                                    onkeyup="mayus(this);" value="<?php echo $row['datoPersonalProveedor'];?>" readonly="readonly">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <div class="input-group-addon"><span class="glyphicon glyphicon-envelope"></span></div>
                                <input name="fecha_oficio" type="text" class="form-control"
                                    required="required" value="<?php echo $row['domicilioPersonal'];?>" readonly="readonly">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input name="grupo" type="text" class="form-control" 
                                    required="required" value="<?php echo $row['telefono'];?>" readonly="readonly">
                            </div>
                        </div>
                        <!--
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <div class="input-group-addon"><span class="glyphicon glyphicon-envelope"></span></div>
                                <input name="fuente" type="text" class="form-control" placeholder="FAX"
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <div class="input-group-addon"><span class="glyphicon glyphicon-envelope"></span></div>
                                <input name="designacion" type="text" class="form-control" 
                                    required="required" value="<?php echo $row['correoElectronico'];?>" readonly="readonly">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input name="proveedor" type="text" class="form-control" placeholder="Proveedor"
                                    value="<?php echo $contrato;?>" readonly="readonly">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <div class="input-group-addon"><span class="glyphicon glyphicon-envelope"></span></div>
                                <input name="OtroProveedor" type="text" class="form-control" placeholder="Otro Proveedor"
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <div class="input-group-addon"><span class="glyphicon glyphicon-envelope"></span></div>
                                <input name="clave_hraei" type="text" class="form-control" placeholder="CLAVE HRAEI"
                                    required="required" value="<?php echo $row['numero_procedimiento'];?>" readonly="readonly">
                            </div>
                        </div>
                        -->
                        <strong>N° de orden de suministro</strong>
                            <div class="input-group">
                                <div class="input-group-addon"><span class="glyphicon glyphicon-envelope"></span></div>
                                <input name="clave_hraei" type="text" class="form-control" placeholder="CLAVE HRAEI"
                                    required="required" onkeyup="mayus(this);" id="claveUnicaContrato">
                            </div>
                        </div>
                        <!--
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <div class="input-group-addon"><span class="glyphicon glyphicon-envelope"></span></div>
                                <input type="text" class="form-control" readonly="readonly" value="ALMACÉN GENERAL DEL HOSPITAL REGIONAL DE ALTA ESPECIALIDAD DE IXTAPALUCA, CARRETERA FEDERAL MÉXICO-PUEBLA KM 34.5, ZOQUIAPAN, IXTAPALUCA, EDOMÉX.">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <div class="input-group-addon"><span class="glyphicon glyphicon-envelope"></span></div>
                                <input type="text" class="form-control" readonly="readonly" value="QUINCE DIAS NATURALES CONTADOS A PARTIR DEL SIGUIENTE DÍA HÁBIL DE LA EMISÓN DE ESTA ÓRDEN DE SUMINISTRO">
                            </div>
                        </div>
                        -->
            </div>
...
<?php
require 'modals/cargarFolio.php';
