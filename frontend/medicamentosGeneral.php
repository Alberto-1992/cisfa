...
<head>
    ...
    <script src="scripts/tablamedicamentoGeneral.js"></script>
    <script src="scripts/tablamedicamentobusGeneral.js"></script>
...
<body>
    ...
    <div id="box1">
        ...
        <input list="consult_medica" class="form-control col-md-4" id="buscardor" type="text"
            onchange="btn_buscar_medicamento();" placeholder="Clave, Nombre o CNIS del Medicamento">
    ...
    <?php
require 'modals/cargarMedicamentoAdmin.php';
?>
