...
cantidad, 
MINIMOPRECIO, 
MAXIMOPRECIO, numeroContrato, tipoAdjudicacion,  DESCRIPCION, count(*) total, farmacia FROM listamedicamento where PROVEEDOR = '$val' and fechaContrato = '2023' or CLAVEHRAEI = '$val' and fechaContrato = '2023' group by listamedicamento.id_medicamento asc ";
