...
<form name="formulario" onSubmit="return limpiar()">
                    <strong>AÑO</strong>
                            <div class="input-group">
                                ...
                                <input id="year" type="text" class="form-control" value="2023"
                                    required="required"
                ...
                $row = mysqli_fetch_assoc($sql_s);
                    $numeroProveedor = $row['numero_proveedor'];
                        ...
                        <strong>NÚMERO DE CONTRATO/PEDIDO</strong>
                            <div class="input-group">
                                <div class="input-group-addon"><span class="glyphicon glyphicon-envelope"></span></div>
                                <input id="numeroContrato" type="text" class="form-control" value="<?php echo $contrato; ?>"
     ...
     var valor= $('#farmaciaTipo').val();
                            ...
                            <div class="input-group">
                                ...
                                <input id="clave_hraei" type="text" class="form-control"
                                     onkeyup="mayus(this);" value="FG-HRAEI-MD">
                            </div>
