...
VALUES(null, '$partida', :claveHraei, :cuadroBasico, :cucop, :descripcionDelBien, :unidadMedida, :minimo, :maximo, :precioUnitario,  $valor3, '$valor2', '$fecha', $diasVencidos, $porcentaje, '$penalizacion', '$cumplioEntrega', '2023', '$dia', 'gratuita')");
