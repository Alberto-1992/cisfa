...
<strong>Numero de proveedor</strong>
							 ...
							 <div class="input-group">
								 ...
								 <select name="tipocontrato" class="form-control" readonly>
									<option value="gratuita 2023" selected>Gratuita 2023</option>
								</select>
							 </div>
	 ...
	 <!--
				 <div class="card">
							 ...
							 <div class="card-body">
							  ...
							  <!--<input type="submit" class="btn btn-danger" style="float: left; margin-left: 10px;" onclick="window.close();" value="Cancelar">-->
