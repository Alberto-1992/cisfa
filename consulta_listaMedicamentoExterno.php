...
$sql = "SELECT COUNT(*) total, PROVEEDOR, GRUPO, fechaContrato FROM listamedicamento where PROVEEDOR = '$val' or GRUPO = '$val' or fechaContrato = '$val' ";
...
cantidad, 
MINIMOPRECIO, 
MAXIMOPRECIO, numeroContrato,  DESCRIPCION, count(*) total FROM listamedicamento where CLAVEHRAEI = '$val' and fechaContrato = '2021' group by listamedicamento.id_medicamento asc ";
...
if(!empty($buscarAlumnos) AND mysqli_num_rows($buscarAlumnos)>0)
{
    ...
    <strong style="float: left; margin-left: 45%; font-size: 23px; font-style: italic; margin-top: 35px;"><input type="text" value="TOTAL DE MEDICAMENTOS  '.$fila['total'].'" style="width: 300px; font-size: 18px;" readonly="readonly"></label></strong>
