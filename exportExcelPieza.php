...
$dateTo = base64_decode($_GET['dateTo2']);
	...
	//Consulta
    $sql = $conexion2->query("SELECT * from covid where clavehraei = '$lab' and fecha between '$dateFrom' and '$dateTo'" );

$salida = "";
$salida .= "<table style='color: black; font-size: 14px;' border=1>";
$salida .= "<thead><th>Clave HRAEI</th><th>Descripcion</th><th>Cantidad</th><th>Fecha</th></thead>";
