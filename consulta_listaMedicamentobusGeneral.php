...
CLAVEHRAEI, 
DESCRIPCION FROM listamedicamento where CLAVEHRAEI like '$val%' and fechaContrato = '2023' or DESCRIPCION like '%$val%' and fechaContrato = '2023' or CLAVEDECUADROBASICO like '%$val%' and fechaContrato = '2023'";
