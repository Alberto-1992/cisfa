...
<?php 
  ...
  $query2="SELECT sum(total) as total2 from facturas where num_factura = '$factura'";
  ...
  function formatMoney($number, $cents = 1) { // cents: 0=never, 1=if needed, 2=always
    ...
    if(!empty($buscarAlumnos) AND mysqli_num_rows($buscarAlumnos)>0)
    {
       ...
       <a href="exportExcelFacturas?factura='.$factura.'" ><i class="fas fa-cloud-download-alt" style="font-size: 25px"></a></i></strong>
