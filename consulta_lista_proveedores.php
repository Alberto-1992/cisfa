...
if(!empty($buscarAlumnos) AND mysqli_num_rows($buscarAlumnos)>0)
{
    ...
    ?>
	<strong style="float: left; margin-left: 45%; font-size: 20px; font-style: italic; margin-top: 50px;"><label>Total <input type="text" value="<?php echo $fila['total'] ?>"></label></strong>
