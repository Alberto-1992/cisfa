...
CLAVEHRAEI, 
DESCRIPCION FROM listamedicamento where CLAVEHRAEI like '%$val%' and fechaContrato = '2023' and farmacia = 'intrahospitalaria' or DESCRIPCION like '%$val%' and fechaContrato = '2023' and farmacia = 'intrahospitalaria' or CLAVEDECUADROBASICO like '%$val%' and fechaContrato = '2023'  and farmacia = 'intrahospitalaria' or DESCRIPCION like '%$val%' and fechaContrato = '2023'  and farmacia = 'intrahospitalaria'";
