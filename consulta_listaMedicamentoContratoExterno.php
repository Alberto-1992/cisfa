...
$sql = "SELECT COUNT(*) total, PROVEEDOR, GRUPO, fechaContrato FROM listamedicamento where PROVEEDOR = '$val' and fechaContrato = '2021' ";
...
cantidad, 
MINIMOPRECIO, 
MAXIMOPRECIO, numeroContrato,  DESCRIPCION, count(*) total FROM listamedicamento where PROVEEDOR = '$val' and fechaContrato = '2021' group by listamedicamento.id_medicamento asc ";
