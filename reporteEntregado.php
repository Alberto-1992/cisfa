...
{ // cents: 0=never, 1=if needed, 2=always
    ...
    $sql = "SELECT * from ordensuministro where fechacontrato = '2023' and ordensuministro.pzasEntrego is not null and ordensuministro.pzasEntrego != 0 and ordensuministro.vigente = 0 and ordensuministro.farmacia = 'intrahospitalaria'" ;
