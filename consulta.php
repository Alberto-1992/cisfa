...
error_reporting(0);
 function formatMoney($number, $cents = 1) { // cents: 0=never, 1=if needed, 2=always
	...
	$sql = "SELECT COUNT(*) total FROM proveedores WHERE year = '$contrato' ";
    ...
    FROM proveedores inner join datosproveedor on datosproveedor.id_datoProveedor = proveedores.numero_proveedor where proveedores.year = '$contrato' and  proveedores.tipoFarmacia = 'intrahospitalaria 2022' or proveedores.year = '$contrato' and  proveedores.tipoFarmacia = 'intrahospitalaria 2021' or proveedores.year = '$contrato' and  proveedores.tipoFarmacia = 'intrahospitalaria 2020' or proveedores.year = '$contrato' and  proveedores.tipoFarmacia = 'intrahospitalaria 2023' ORDER by datosproveedor.datoPersonalProveedor asc";
