            ...
            <div class="modal-body">
                <script>
                    function select_proveedormedicamento() {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "modelo/modelo_cargar_medicamentoFG.php",
                            data: ob,
                ...
                <datalist id="lista">
                    ...
                    $sql_s = $conexion2->query("SELECT numero_pedido, numero_proveedor FROM proveedores where year = '2023' and tipoFarmacia = 'Gratuita 2023'");
