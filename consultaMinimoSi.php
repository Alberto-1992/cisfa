...
cantidad, 
MINIMOPRECIO, 
MAXIMOPRECIO, LEFT(DESCRIPCION,400) AS DESCRIPCION, count(*) total, numeroContrato, farmacia FROM listamedicamento where cantidad >= minimoconsumo and fechaContrato = '2022' group by listamedicamento.cantidad asc ";
...
if(!empty($buscarAlumnos) AND mysqli_num_rows($buscarAlumnos)>0)
{
    ...
    '
    <strong style="float: left; margin-left: 45%; font-size: 25px; font-style: italic; margin-top: -35px;"><label>Minimos alcanzados <input type="text" value='.$fila['total'].'></label></strong>
