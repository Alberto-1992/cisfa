...
CLAVEHRAEI, 
DESCRIPCION FROM listamedicamento where CLAVEHRAEI like '%$val%' and fechaContrato = '2023' and farmacia = 'gratuita' or DESCRIPCION like '%$val%' and fechaContrato = '2023'  and farmacia = 'gratuita' or CLAVEDECUADROBASICO like '%$val%' and fechaContrato = '2023'  and farmacia = 'gratuita'";
...
?>
  ...
  $('table').on('click', '.checks', function(){ 
    ...
    let ob = {ID_usuario:ID_usuario};
     ...
     $.ajax({
                type: "POST",
                url:"consulta_listaMedicamentoFG.php",
                data: ob,
