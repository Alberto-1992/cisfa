...
error_reporting(0);
 function formatMoney($number, $cents = 1) { // cents: 0=never, 1=if needed, 2=always
	...
	$sql = "SELECT COUNT(*) total FROM proveedores WHERE year = '2023' and tipoFarmacia = 'gratuita 2023'";
    ...
    FROM proveedores left outer join datosproveedor on datosproveedor.id_datoProveedor = proveedores.numero_proveedor where proveedores.year = '2023' and tipoFarmacia = 'gratuita 2023' ORDER by datosproveedor.datoPersonalProveedor asc");
