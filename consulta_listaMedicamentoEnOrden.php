...
importe, 
claveContrato,
claveUnicaOrden FROM ordensuministro where claveHraei like '%$ID_usuario%' and fechaorden like '%2023%' and farmacia = 'intrahospitalaria'");
...
<script>
  ...
  $('table').on('click', '.ver-info', function(){ 
      ...
      var clave = $(this).prop('id');
        window.open ('seguimientoEntrega?claveEntrega='+clave);
    });
  });
</script>
</html>
