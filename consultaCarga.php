...
error_reporting(0);
 function formatMoney($number, $cents = 1) { // cents: 0=never, 1=if needed, 2=always
	...
	$sql = "SELECT COUNT(*) total FROM proveedores WHERE year = '2023' and tipoFarmacia = 'intrahospitalaria 2023'";
    ...
    FROM proveedores left outer join datosproveedor on datosproveedor.id_datoProveedor = proveedores.numero_proveedor where proveedores.year = '2023' and tipoFarmacia = 'intrahospitalaria 2023' ORDER by datosproveedor.datoPersonalProveedor asc");
    ...
    <?php
        ...
        while($dataRegistro= mysqli_fetch_assoc($query))
        {
            ...
            <tr>
                ...
                <td><a href="ordenSuminstro?Xy='<?php echo $valor ?>'&tr='<?php echo $contrato ?>'" target="popup" onClick="window.open(this.href, this.target, "width=1100,height=600,top=15px, left=220,scrollbars=NO,menubar=NO,titlebar= NO,status=NO,toolbar=NO" ); return false;"
                ...
                <!--<td><a  href="verContrato?Xy='<?php echo $valor ?>'" style="font-size: 24px; color: yellow; background: none; border: none;" class="lnr lnr-exit"></a></td>-->
