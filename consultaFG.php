...
error_reporting(0);
 function formatMoney($number, $cents = 1) { // cents: 0=never, 1=if needed, 2=always
	...
	$sql = "SELECT COUNT(*) total FROM proveedores WHERE year = '$contrato' and tipoFarmacia = 'intrahospitalaria 2022' or year = '$contrato' and tipoFarmacia = 'intrahospitalaria 2021' or year = '$contrato' and tipoFarmacia = 'intrahospitalaria 2020'";
    ...
    FROM proveedores inner join datosproveedor on datosproveedor.id_datoProveedor = proveedores.numero_proveedor where proveedores.year = '$contrato' and tipoFarmacia = 'gratutita 2022' ORDER by proveedores.nombre_proveedor asc";
