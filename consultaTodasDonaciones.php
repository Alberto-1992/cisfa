...
<body>
  ...
  $fecha = $_POST['fecha'];
  $query2 = "SELECT sum(cantidadrecibida) as total from donaciones";
  ...
  $tabla = "";
  $query = "SELECT *
     from donaciones where anoentrada like '$fecha%'";
  ...
  if (!empty($buscarAlumnos) and mysqli_num_rows($buscarAlumnos) > 0) {
    ...
    $tabla .=
      ...
      '
        <strong style="float: left; margin-left:0 %; font-size: 20px; margin-top: 70px; font-style: italic;"><label>Total donaciones <input type="text" value=' . $result2['total'] . '></label><a href="exportExcelFacturasTodas" ><i class="fas fa-cloud-download-alt" style="font-size: 25px"></a></i></strong>
