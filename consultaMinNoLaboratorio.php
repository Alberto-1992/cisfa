...
$sql = $conexion2->query("SELECT COUNT(*) total FROM listamedicamento where cantidad < minimoconsumo and numeroContrato = '$proveedor'");
...
cantidad, 
MINIMOPRECIO, 
MAXIMOPRECIO, LEFT(DESCRIPCION,400) AS DESCRIPCION, count(*) total FROM listamedicamento where cantidad < minimoconsumo and numeroContrato = '$proveedor' group by listamedicamento.CLAVEHRAEI asc ";
